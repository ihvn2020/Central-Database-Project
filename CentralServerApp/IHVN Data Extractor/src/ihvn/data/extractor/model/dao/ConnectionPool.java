...
public class ConnectionPool implements Runnable {
	...
	/**
	 * Method to Close all the connections. Use with caution: be sure no connections are in use
	 * before calling. Note that you are not <I>required</I> to call this when done with a
	 * ConnectionPool, since connections are guaranteed to be closed when garbage collected. But
	 * this method gives more control regarding when the connections are closed.
	 */
