 ...
 *         &lt;element name="PatientBiometric" type="{}PatientBiometricType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PatientProgram" type="{}PatientProgramType" maxOccurs="unbounded" minOccurs="0"/>
...
public class DemographicsType {
    ...
    protected List<PatientBiometricType> patientBiometric;
    @XmlElement(name = "PatientProgram")
    protected List<PatientProgramType> patientProgram;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the patientBiometric property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPatientBiometric().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PatientBiometricType> getPatientBiometric() {
        if (patientBiometric == null) {
            patientBiometric = new ArrayList<PatientBiometricType>();
        }
        return this.patientBiometric;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the patientProgram property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPatientProgram().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PatientProgramType> getPatientProgram() {
        if (patientProgram == null) {
            patientProgram = new ArrayList<PatientProgramType>();
        }
